...
public class SQL_4_1_1 {
    ...
    public static void main(String[] args) {
        ...
        try(Connection conexion = DriverManager.getConnection(url, username, password)){
            ...
            //String subconsulta = "";
                String consulta = "SELECT * FROM empleados WHERE id_departamento = (SELECT id_departamento FROM departamentos WHERE nombre_departamento = 'Ventas'); ";
                ...
                try(ResultSet resultado = sentencia.executeQuery(consulta)){
                  //Recorro los resultados:
                    while(resultado.next()) {
                        ...
                        SQL_4_1_1 empleado = new SQL_4_1_1(id_empleado, nombre, apellido,email
    ...
    public SQL_4_1_1(int id_empleado, String nombre, String apellido, String email, String telefono, Calendar fechaContratacion, String id_trabajo, float salario, float comision) {
